                                                ...
                                                <ul class="panel-heading-tabs border-light">
                                                    <li>
                                                        <div class="pull-right">
                                                            <a href="{{ route('pos.create') }}" class="btn btn-green btn-sm" style="margin-top: 9px;"><i class="fa fa-plus"></i> Nouveau </a>
                                                ...
                                                <table class="table table-stylish sample_5">
                                                    ...
                                                    @foreach ($datas as $data)
                                                        <tr>
                                                            <td>{{ $loop->index + 1 }}</td>
                                                            <td>{{ $data->name }}</td>
                                                            <td><a href="{{ route('pos.show', $data->id) }}"><i class="fa fa-eye"></i></a></td>
                                                        </tr>
                                                    @endforeach
