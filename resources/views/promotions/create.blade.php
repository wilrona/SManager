...
@section('content')
    <div class="wrap-content container" id="container">
        ...
        <div class="breadcrumb-wrapper">
            <h4 class="mainTitle no-margin">Création d'une promotion</h4>
                ...
                <div class="col-md-8">
                    <div class="panel panel-white">
                        <div class="panel-heading">
                            <h3 class="panel-title">Information sur la promotion</h3>
                        </div>
                        <div class="panel-body">
                            ...
                            <div class="form-group {!! $errors->has('date_debut') ? 'has-error' : '' !!}">
                                ...
                                {!! Form::text('date_debut', null, ['class' => 'form-control datepicker_start', 'placeholder' => 'Date de début', 'readonly' => '']) !!}
                            ...
                            <div class="form-group {!! $errors->has('date_fin') ? 'has-error' : '' !!}">
                                ...
                                {!! Form::text('date_fin', null, ['class' => 'form-control datepicker_end', 'placeholder' => 'Date de fin', 'readonly' => '']) !!}
