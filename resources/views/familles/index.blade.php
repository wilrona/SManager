                                                ...
                                                <ul class="panel-heading-tabs border-light">
                                                    <li>
                                                        <div class="pull-right">
                                                            <a @if($type == 0) href="{{ route('famillepro.create') }}" @else href="{{ route('famillecli.create') }}" @endif class="btn btn-green btn-sm" style="margin-top: 9px;"><i class="fa fa-plus"></i> Nouveau </a>
                                            ...
                                            <div class="panel-body">
                                                <table class="table  sample_5">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th>Famille @if($type == 0) produit @else client @endif</th>
                                                        <th class="col-xs-1"></th>
                                                    </tr>
                                                    </thead>
                                                    <tbody>
                                                    @foreach ($datas as $data)
                                                        <tr>
                                                            <td>{{ $loop->index + 1 }}</td>
                                                            <td>{{ $data->name }}</td>
                                                            <td><a href="{{ route('famille.show', $data->id) }}"><i class="fa fa-eye"></i></a></td>
                                                        </tr>
                                                    @endforeach
