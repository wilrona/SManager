...
@section('content')
    <div class="wrap-content container" id="container">
        ...
        <div class="container-fluid container-fullw padding-bottom-10">
            <div class="row">
                <div class="col-md-8">
                    {!! Form::model($data, ['route' => ['unite.update', $data->id]]) !!}
                    <div class="panel panel-white">
                        <div class="panel-heading border-light">
                            <h4 class="panel-title">Information sur le point de vente</h4>
                            <ul class="panel-heading-tabs border-light">
                                <li class="middle-center">
                                    <a href="{{ route('unite.show', $data->id) }}" class="btn btn-o btn-sm btn-default">Retour</a>
                                </li>
                                <li class="middle-center">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group {!! $errors->has('name') ? 'has-error' : '' !!}">
                                ...
                                {!! Form::text('name', null, ['class' => 'form-control', 'placeholder' => 'Nom unité de produit']) !!}
                                {!! Form::hidden('type') !!}
