...
@section('content')
    ...
    <div class="wrap-content container" id="container">
        ...
        <div class="breadcrumb-wrapper">
            <h4 class="mainTitle no-margin">Modification du profile</h4>
        ...
        <div class="container-fluid container-fullw padding-bottom-10">
            <div class="row">
                <div class="col-md-8">
                    {!! Form::model($data, ['route' => ['profile.update', $data->id]]) !!}
                    <div class="panel panel-white">
                        <div class="panel-heading border-light">
                            <h4 class="panel-title">Information du profile</h4>
                            <ul class="panel-heading-tabs border-light">
                                <li class="middle-center">
                                    <a href="{{ route('profile.show', $data->id) }}" class="btn btn-o btn-sm btn-default">Retour</a>
                                </li>
                                <li class="middle-center">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group {!! $errors->has('name') ? 'has-error' : '' !!}">
                                ...
                                {!! Form::text('name', $data->name, ['class' => 'form-control', 'placeholder' => 'Nom du profile']) !!}
                            ...
                            <div class="form-group {!! $errors->has('description') ? 'has-error' : '' !!}">
                                ...
                                {!! Form::textarea('description', $data->description, ['class' => 'form-control', 'placeholder' => 'Entrer une description']) !!}
