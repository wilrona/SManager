            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <span class="input-group-addon"> / {{ $qte_exp - $qte_recept }} </span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="table-no-search">
        <table class="table sample_5 table-bordered">
            ...
            @foreach ($datas->Series()->get() as $data)
                ...
                <tr class="" id="{{ $data->id }}">
                    <td>
                        <input type="checkbox" name="produit[]" value="{{ $data->id }}" @if($data->pivot->ok == 1) checked @endif class="checkbox-item checkbox_{{ $data->id }}">
                    </td>
...
<div class="modal-footer">
    ...
    <input type="button"  id="submits" class="btn btn-blue btn-sm" value="Valider la reception"/>
</div>
